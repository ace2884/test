...
Here are 20 Python programs based on arrays (lists) using array/list methods and concepts. 
...
Here are a few Python programs based on string manipulation using built-in string methods:
